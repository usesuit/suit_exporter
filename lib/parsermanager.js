...
(function () {
    ...
    ParserManager.prototype._parseLayerName = function (layerName) {
      ...
      if(layerName.indexOf("alias") == 0 || layerName.indexOf("text") == 0 || layerName.indexOf("pivot") == 0 || layerName.indexOf("placeholder") == 0 || layerName.indexOf("tile") == 0 || layerName.indexOf("container") == 0)
      {
        return [{"name":layerName}];
      }
      ...
      var component = { widthUnit: "px", heightUnit: "px", quality: 32, file: layerName.replace(/ /g,"_") + ".png", extension: "png" };
